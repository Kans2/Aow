  ...
  return (
    <section className="py-16 text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        {/* Card container */}
        <div className="flex flex-col md:block items-center gap-8 md:gap-0 mb-16 relative h-auto md:h-[450px] mt-8">
          {/* Skill Library Card - Tilted Left on Desktop */}
          <div className="bg-white rounded-xl p-6 text-black max-w-xs w-full md:w-72 md:h-[350px] relative md:absolute md:left-[calc(50%-320px)] md:top-12 md:-rotate-[15deg] md:hover:rotate-0 hover:-translate-y-4 md:hover:-translate-y-8 hover:z-30 transition-all duration-500 shadow-xl z-10 origin-bottom-right cursor-pointer">
          ...
          <div className="bg-white rounded-xl p-6 text-black max-w-xs w-full md:w-72 md:h-[350px] relative md:absolute md:left-[calc(50%-144px)] md:top-4 hover:-translate-y-4 md:hover:-translate-y-8 hover:z-30 transition-all duration-500 shadow-2xl z-20 cursor-pointer">
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 bg-[#c3dfff] rounded-full flex items-center justify-center overflow-hidden">
                <img
          ...
          {/* Flexible Pricing Card - Tilted Right on Desktop */}
          <div className="bg-white rounded-xl p-6 text-black max-w-xs w-full md:w-72 md:h-[350px] relative md:absolute md:right-[calc(50%-320px)] md:top-12 md:rotate-[15deg] md:hover:rotate-0 hover:-translate-y-4 md:hover:-translate-y-8 hover:z-30 transition-all duration-500 shadow-xl z-10 origin-bottom-left cursor-pointer">
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 bg-[#c3dfff] rounded-full flex items-center justify-center overflow-hidden">
                <img
