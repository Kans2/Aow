        ...
        >
          ...
          >
            ...
            <p className="text-[#272727] mb-6">
              Your assessment slot has been scheduled successfully. A
              confirmation with your testing centre details has been sent to
              your registered email.
            </p>

            <button
              onClick={() => setShowThankYou(false)}
              className="px-10 py-2.5 rounded bg-[#2d5184] text-white font-medium hover:opacity-90"
            >
              Close
            </button>
          </div>
