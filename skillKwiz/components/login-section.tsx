    ...
    <section className="py-16 bg-[#000c2a]">
      <div className="max-w-5xl mx-auto px-6">
        <div className="bg-white rounded-lg overflow-hidden shadow-xl flex flex-col md:flex-row">
          {/* Left side - Visual */}
          <div className="w-full md:w-1/2 relative min-h-[280px] md:min-h-[520px] bg-white">
            <Image
              src="/images/aboutpage/aboutus_whoweare.png"
              alt="Professionals joining hands"
              fill
          ...
          <div className="w-full md:w-1/2 bg-[#00418d] p-8 flex items-center">
            <div className="w-full">
              ...
              <div className="flex mb-6 rounded-md bg-white/10 p-1">
                <button
                  type="button"
              ...
              <h2 className="text-xl font-bold text-white mb-6">
                {isSignUp ? "Create your Skill Kwiz account" : "Sign in to Skill Kwiz"}
              </h2>
              ...
              <form className="space-y-4">
                ...
                {isSignUp ? (
                  <label className="flex items-start text-white text-sm">
                    <input type="checkbox" className="h-4 w-4 mr-2 mt-0.5" />
                    <span>
                      I agree to the{" "}
