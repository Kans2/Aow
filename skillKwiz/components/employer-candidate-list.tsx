...
// Single placeholder report served for every "View Report" button
const REPORT_FILE = "/downloads/skillkwiz-report.pdf";
            ...
            <div key={candidate.id} className="bg-[#4a63b3]/80 rounded-lg p-4">
              <div className="flex items-center justify-between">
                ...
                <a
                  href={REPORT_FILE}
                  download
                  className="bg-[#00bcd4] text-white px-4 py-2 rounded-lg hover:bg-[#00a5bb] whitespace-nowrap"
                >
                  View Report
                </a>
              </div>
