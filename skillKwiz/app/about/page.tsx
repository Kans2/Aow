          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="w-full md:w-1/2 flex justify-center gap-4">
              <Image
                ...
                height={200}
                width={100}
                className="rounded-lg w-auto h-auto max-h-[280px] object-contain animate-float-delay-2"
              />
              <Image
                ...
                height={200}
                width={100}
                className="rounded-lg w-auto h-auto max-h-[280px] object-contain animate-float-delay-1"
              />
              <Image
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="relative">
            <video
              ...
              preload="metadata"
            >
              {/* #t=0.5 makes the browser seek half a second in, so the
                  thumbnail is a real frame from the video */}
              <source
                src="/images/aboutpage/about_video.mp4#t=0.5"
                type="video/mp4"
              />
              Your browser does not support the video tag.
            </video>
